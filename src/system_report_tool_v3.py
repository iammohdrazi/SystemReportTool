...
import platform, psutil, socket, os, sys
...
def get_hardware_status():
    return {
        ...
        "Temperature": hasattr(psutil, "sensors_temperatures") and bool(psutil.sensors_temperatures()) if sys.platform != "win32" else False,
...
<body class="bg-gray-50 text-gray-900">
    ...
    <div class="max-w-7xl mx-auto px-4 py-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            <div class="bg-white rounded-xl shadow p-4 border tile">
                <h2 class="text-lg font-semibold mb-3"><i class="ti ti-device-desktop text-gray-700"></i> System Info</h2>
            ...
            <div class="bg-white rounded-xl shadow p-4 border tile">
                <h2 class="text-lg font-semibold mb-3"><i class="ti ti-battery text-yellow-600"></i> Battery Info</h2>
                <ul class="text-sm space-y-1">
            ...
            <div class="bg-white rounded-xl shadow p-4 border tile">
                <h2 class="text-lg font-semibold mb-3"><i class="ti ti-wifi text-blue-600"></i> Network Info</h2>
                <ul class="text-sm space-y-1">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="bg-white rounded-xl shadow p-4 border tile">
                <h2 class="text-lg font-semibold mb-3"><i class="ti ti-cpu text-red-600"></i> CPU Info</h2>
                <ul class="text-sm">
            ...
            <div class="bg-white rounded-xl shadow p-4 border tile">
                <h2 class="text-lg font-semibold mb-3"><i class="ti ti-chip text-purple-600"></i> Memory Info</h2>
        ...
        <div class="bg-white rounded-xl shadow p-4 border mt-6 tile">
            <h2 class="text-lg font-semibold mb-3"><i class="ti ti-device-sd-card text-green-600"></i> Disk Info</h2>
        ...
        <div class="bg-white rounded-xl shadow p-4 border mt-6 tile">
            <h2 class="text-lg font-semibold mb-3"><i class="ti ti-tools text-indigo-600"></i> Hardware Summary</h2>
            <ul class="text-sm space-y-1">
